...
### Persona 3 — [Kshitij Mishra](mailto:kshitij@scaler.com)
...
| - | -------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 | GitHub Repository          | 2     | Clean repo structure,.env.examplepresent, no API keys committed, clear README with setup steps and screenshots                                                                              |
...
| 5 | Documentation & Reflection | 2     | prompts.mdfile in the repo with all three system prompts annotated. 300–500 word reflection covering: what worked, what the GIGO principle taught you, and what you would improve.         |
